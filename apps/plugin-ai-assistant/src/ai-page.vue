  ...
  <div class="ai-page">
    <div class="ai-page-header">
      ...
      <div class="ai-page-header-actions">
        <button class="ai-page-btn" :class="{ 'is-active': aiState.activeTab === 'chat' }" :title="t('ai.chat')" @click="aiState.activeTab = 'chat'">
          ...
          <span class="btn-text">{{ t('ai.chat') }}</span>
        </button>
        <button class="ai-page-btn" :class="{ 'is-active': aiState.activeTab === 'topics' }" :title="t('ai.topics')" @click="aiState.activeTab = 'topics'">
          ...
          <span class="btn-text">{{ t('ai.topics') }}</span>
        </button>
        <button class="ai-page-btn" :class="{ 'is-active': aiState.activeTab === 'settings' }" :title="t('ai.settings')" @click="aiState.activeTab = 'settings'">
          ...
          <span class="btn-text">{{ t('ai.settings') }}</span>
        </button>
      </div>
    </div>
